...
export const REMODELACIONES_MARKETS: Record<RemodelacionesMarketId, RemodelacionesMarket> = {
  cl: {
    ...
    term: 'remodelación',
    industryLabel: 'empresas de remodelaciones',
  ...
  es: {
    ...
    term: 'reforma',
    industryLabel: 'empresas de reformas',
    citiesHint: 'Madrid, Barcelona, Valencia y comunidades',
    whatsappMessage:
      'Hola Cluster Media, quiero un diagnóstico de conversión de presupuestos para mi empresa de reformas en España.',
    implementationFromUsd: 1000,
    implementationFromLocal: null,
    showMonthly: false,
    monthlyFromUsd: null,
  ...
  mx: {
    ...
    whatsappMessage:
      'Hola Cluster Media, quiero un diagnóstico de conversión de presupuestos para mi empresa de remodelaciones en México.',
    implementationFromUsd: 1000,
    implementationFromLocal: null,
    showMonthly: false,
    monthlyFromUsd: null,
  ...
  pa: {
    ...
    whatsappMessage:
      'Hola Cluster Media, quiero un diagnóstico de conversión de presupuestos para mi empresa de remodelaciones en Panamá.',
    implementationFromUsd: 1000,
    implementationFromLocal: null,
    showMonthly: false,
    monthlyFromUsd: null,
