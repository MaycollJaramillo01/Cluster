...
import { GraciasActions } from '@/components/clinicas-esteticas/GraciasActions';
import { getCountry, isCountryCode } from '@/lib/clinicas-esteticas/countries';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/clinicas-esteticas/gracias' },
};
...
export default async function GraciasPage({ searchParams }: Props) {
  ...
  const country = getCountry(isCountryCode(pais || '') ? pais : 'pa');
