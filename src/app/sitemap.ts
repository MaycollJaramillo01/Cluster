...
const routes = [
  ...
  { path: '/clinicas-esteticas', priority: 0.95, freq: 'weekly' as const },
  { path: '/clinicas-esteticas/pa', priority: 0.9, freq: 'weekly' as const },
  { path: '/clinicas-esteticas/cl', priority: 0.9, freq: 'weekly' as const },
  { path: '/clinicas-esteticas/es', priority: 0.85, freq: 'monthly' as const },
  { path: '/clinicas-esteticas/mx', priority: 0.85, freq: 'monthly' as const },
  { path: '/inmobiliarias', priority: 0.95, freq: 'weekly' as const },
  { path: '/inmobiliarias/do', priority: 0.9, freq: 'weekly' as const },
  { path: '/inmobiliarias/pa', priority: 0.9, freq: 'weekly' as const },
  { path: '/inmobiliarias/cl', priority: 0.9, freq: 'weekly' as const },
  { path: '/inmobiliarias/es', priority: 0.85, freq: 'monthly' as const },
  { path: '/inmobiliarias/mx', priority: 0.85, freq: 'monthly' as const },
  ...
  { path: '/carreras', priority: 0.7, freq: 'weekly' as const },
