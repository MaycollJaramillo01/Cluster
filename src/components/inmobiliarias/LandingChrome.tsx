...
import { captureUtms, trackEvent } from '@/lib/inmobiliarias/tracking';
...
export function LandingChrome({ country }: Props) {
  ...
  const waMsg = `Hola Cluster Media, vi la landing de inmobiliarias (${country.name}) y quiero hablar.`;
